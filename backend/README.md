...
## Project Structure
    ...
    ├── testapiautocatalog_115829  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_115829`
...
2. Clone this repo and `cd testapiautocatalog_115829`
